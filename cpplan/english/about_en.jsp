...
<body>
    ...
    <div class="parallax-window" data-parallax="scroll" data-image-src="./img/bg_about4.jpg">
        <div class="bText">
            <h2>About Us</h2>
            <p>Advertising marketing, content production <br> website production, etc.</p>
            <p>Various commercials at once!</p>
        </div>
    </div>
    <!--조직도-->
    <!-- <div class="about_container2">
        ...
        data-aos-duration="2000">
            <img src="./img/about/group-en.png" alt="">
        </div>
    </div> -->
    <!-- about -->
        ...
        <div class="team_box">
                ...
                data-aos-duration="2000">
                    ...
                    <div class="team_ad_text text_sc">
                        ...
                        <p>Identify client needs.
                            <br>Establish an overall advertising plan.</p>
                        <p>- Brand Strategy Settings</p>
                        <p>- Customer / User Analysis</p>
                        <p>- Establishment of advertising plans</p>
                    </div>
                </div>
                ...
                data-aos-duration="2000">
                    ...
                    <div class="team_d_text text_sc">
                        ...
                        <p>Through a variety of online and offline channels<br> 
                            We prioritize direct communication with customers.
                            </p>
                        <p>- Performance marketing</p>
                        <p>- Gross Hacking Marketing</p>
                        <p>- Viral marketing</p>
                    </div>
                </div>
                ...
                data-aos-duration="2000">
                    ...
                    <div class="team_v_text text_sc">
                        ...
                        <p>Suitable for the client's advertising<br> 
                            Design content.</p>
                        <p>- Online content design</p>
                        <p>- Offline advertising design</p>
                    </div>
                </div>
                ...
                data-aos-duration="2000">
                    ...
                    <div class="team_w_text text_sc">
                        <h3>Media</h3>
                        <p>Planning and filming video content<br> 
                            Create content that is specific to the platform-specific content.</p>
                        <p>- Video content planning and filming</p>
                        <p>- Edit to suit platform properties</p>
                    </div>
                </div>
                ...
                data-aos-duration="2000">
                    ...
                    <div class="team_w6_text text_sc">
                        <h3>Web Making</h3>
                        <p>We provide web services for various platforms.</p>
                        <p>- Website production</p>
                        <p>- Program development and maintenance</p>
                    </div>
                </div>
                ...
                data-aos-duration="2000">
                    ...
                    <div class="team_w5_text text_sc">
                        <h3>Contents</h3>
                        <p>Create content that fits both online and offline.<br>
                            It helps brand and advertising marketing efficiency.</p>
                        <p>- Create online content</p>
