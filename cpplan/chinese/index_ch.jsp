...
<body>
        ...
        <div class="ceoMe pathAni">
            ...
            <ul class="path">
                <li>
                    <ul class="aniTxt">
                        <li>
                            <span class="boldT scaleT1">广</span><span class="boldT scaleT2">告</span><span class="pFade">, 那个不难!</span>
                        </li>
                        <li>
                            <span class="pFade">战略商业伙伴</span>
                        </li>
                        <li class="boldL">
    ...
    <div class="mainCon">
        <div class="ceoMe">
            ...
            <h3 data-aos="fade-down" data-aos-duration="900">综合营销沟通</h3>
    ...
    <div class="mainCon organ">
        <div class="ceoMe organCon">
            <img src="../img/main/group-ch.png" alt="조직도" data-aos="fade-in" data-aos-duration="1000">
        </div>
    </div>
