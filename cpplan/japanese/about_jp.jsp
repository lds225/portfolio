...
<body>
    ...
    <div class="parallax-window" data-parallax="scroll" data-image-src="./img/bg_about4.jpg">
        <div class="bText">
            <h2>About Us</h2>
            <p>広告マーケティング·コンテンツ制作·ウェブサイト制作など</p>
            <p>色んな広告を一度に！</p>
        </div>
    </div>
    <!--조직도-->
    <!-- <div class="about_container2">
        ...
        data-aos-duration="2000">
            <img src="./img/about/group-jp.png" alt="">
        </div>
    </div> -->
    <!-- about -->
        ...
        <div class="team_box">
                ...
                data-aos-duration="2000">
                    ...
                    <div class="team_d_text text_sc">
                        ...
                        <p>様々なオンオフラインチャンネルを通じて<br> 
                            直接お客様とのコミュニケーションを優先します。
                            </p>
                        <p>- パフォーマンスマーケティング</p>
                        <p>- グロスハッキングマーケティング</p>
                        <p>- バイラルマーケティング</p>
                ...
                data-aos-duration="2000">
                    ...
                    <div class="team_w_text text_sc">
                        <h3>Media</h3>
                        <p>映像コンテンツを企画·撮影し、<br> 
                            プラットフォームに特化したコンテンツを制作します。</p>
                        <p>- 映像コンテンツの企画及び撮影</p>
                        <p>- プラットフォームの特性に合わせた編集</p>
                    </div>
                </div>
                ...
                data-aos-duration="2000">
                    ...
                    <div class="team_w6_text text_sc">
                        <h3>Web Making</h3>
                        <p>様々なプラットフォームに合わせたウェブサービスをご提供しています。</p>
                        <p>- ウェブサイト制作</p>
                        <p>- プログラム開発及びメンテナンス</p>
                    </div>
                </div>
                ...
                data-aos-duration="2000">
                    ...
                    <div class="team_w5_text text_sc">
                        <h3>Contents</h3>
                        <p>オンオフラインに合わせたコンテンツを制作して<br>
                            ブランド·広告のマーケティング効率をお手伝いします。</p>
                        <p>- オンラインコンテンツ制作</p>
                        <p>- オフラインコンテンツ制作</p>
                    </div>
                </div>
